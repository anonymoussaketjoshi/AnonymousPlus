...
public class saketApiHelper extends Activity implements EasyPermissions.PermissionCallbacks{
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        /* SAKET ADDED to update the table
        ...
        private void updateData() throws IOException {
            ...
            List<Object> data1 = new ArrayList<Object>(), data2 = new ArrayList<Object>();
            data2.add("RULES");
            data1.add("Saket");
            //data1.add("isAwesome");
            ...
            BatchUpdateSpreadsheetRequest addCol = new BatchUpdateSpreadsheetRequest();
            BatchUpdateValuesResponse oResp1 = this.mService.spreadsheets().values().batchUpdate(spreadsheetId,oRequest).execute();
        }
        private void appendCol() throws IOException{
            String spreadsheetId = "1u6f5CySr98DB7mdIGDopmRIErGFmmrzbofUniASErCo";
            ...
            BatchUpdateSpreadsheetResponse response = this.mService.spreadsheets().batchUpdate(spreadsheetId,body).execute();

        }
        /**
         * Fetch a list of names and majors of students in a sample spreadsheet:
         * https://docs.google.com/spreadsheets/d/1BxiMVs0XRA5nFMdKvBdBZjgmUUqptlbs74OgvE2upms/edit
         * https://docs.google.com/spreadsheets/d/1u6f5CySr98DB7mdIGDopmRIErGFmmrzbofUniASErCo/edit?usp=sharing
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            saketApiHelper.REQUEST_AUTHORIZATION);
                } else {
